...
$query=mysql_query ("SELECT * FROM publikkonten WHERE tipepublik='tentangkami'",$connection)or die (mysql_error());
...
?>
    ...
    <!-- Start: MAIN CONTENT -->
        <div class="page-header">
            <h2>Edit Public Content : Tentang Kami</h2>
          </div>
              ...
              <div class="center-align">
                <form class="form-horizontal form-signin-signup" action="prosesadmin/prosesubahkontenpubliktentangkamiadmin.php" method="POST"enctype="multipart/form-data">
...
<!-- /TinyMCE -->
    <p>
    <textarea name="kontententangkami" cols="80" rows="10" id="kontententangkami" placeholder="Content Public - Tentang Kami"><?php echo $konten; ?></textarea>
    </p>
    </td>
    <td width="11">&nbsp;</td>
  </tr>
